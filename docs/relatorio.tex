...
Nos dois tipos de serviços disponíveis, a reparação do equipamento está associada a um plano de trabalhos. % plano é  guia da reparação % 
...
% Principais dificuldades: Inicialmente divisão dos cenários por uses cases, o que incluir no modelo de use case da reparação de um equipamento
%                           Como definir os passos da reparação, como defenir cada passo surgindo a ideia do material, 
%                           associação do cliente e o colaborador(associação para relação n-ária), presença do system timer no dominio como classe,  ... 
%
