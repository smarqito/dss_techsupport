...
Por sua vez, quando se trata de um grande volume de clientes e, por sua vez, bastantes equipamentos com variadas reparações, seria bastante útil adquirir este sistema 
...
realizado na primeira fase, e onde foram definidas as classes e métodos que compoẽm o sistema. Posteriormente, \textbf{diagramas de sequência} 
...
Também é de salientar que neste subsistema predomina uma arquitetura com agregação entre classes.
