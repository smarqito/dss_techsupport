...
\begin{itemize}
    ...
    \item[Pós-condição] {Equipamento adicionado à lista de equipamentos por reparar}
          ...
          \begin{enumerate}
              ...
              \item Sistem verifica disponibilidade
          ...
          \begin{flushleft}
              \textbf{Fluxo de Exceção 1 (passo 2) [Não existe disponibilidade de tempo]}
          \end{flushleft}
          \begin{itemize}
          ...
          \end{itemize}
          \begin{flushleft}
              \textbf{Fluxo Alternativo 2 (passo 6) [Equipamento não registado]}
          \end{flushleft}
          \begin{itemize}
...
\begin{landscape}
    \begin{table}[!h]
        ...
        \begin{tabular}{|p{5cm}|p{1cm}|p{4cm}|p{6cm}|p{3cm}|}
            ...
            \\
            \hline
            Sistem verifica disponibilidade
                     & 
            ...
            Sistema seleciona cliente
                     & 
                     & seleciona o cliente
                     & getCliente(CliID : String) : boolean
                     & SubUtilizadores
            \\
            \hline
            \rowcolor{yellow}
            ...
            Sistema seleciona equipamento
                     ...
                     & getEquipamento(EquipID : String) : boolean
                     & SubReparacoes
            \\
            \hline
            \rowcolor{yellow}
            ...
            Sistema adiciona pedido
                     ...
                     & adicionaPedRepXpresso(cliID : String, EquiID : String, nomeRepXpresso : String)
                     & SubReparacoes
            \\
            \hline
            \rowcolor{red!30}
